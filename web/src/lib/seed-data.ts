...
export const SEED_USERS: UserProfile[] = [
  {
    ...
    avatar_url: null,
    home_community_id: "comm-mexican-american",
    verification_level: 2,
    ghost_mode: false,
    default_radius_miles: 20,
    created_at: "2026-02-15T10:00:00Z",
    perspectives_read: 142,
  ...
  },
  {
    ...
    avatar_url: null,
    home_community_id: "comm-rural-appalachia",
    verification_level: 2,
    ghost_mode: false,
    default_radius_miles: 30,
    created_at: "2026-02-20T14:00:00Z",
    perspectives_read: 89,
  ...
  },
  {
    ...
    perspectives_read: 204,
    communities_engaged: 11,
    connections_made: 8,
  },
  {
    id: "user-4",
    email: "terrence.w@example.com",
    username: "terrence_atl",
    display_name: "Terrence Williams",
    avatar_url: null,
    home_community_id: "comm-hbcu-students",
    verification_level: 2,
    ghost_mode: false,
    default_radius_miles: 10,
    created_at: "2026-03-05T11:00:00Z",
    perspectives_read: 67,
    communities_engaged: 4,
    connections_made: 2,
  },
  {
    id: "user-5",
    email: "lakota.h@example.com",
    username: "lakota_pr",
    display_name: "Lakota Hawk",
    avatar_url: null,
    home_community_id: "comm-native-tribal",
    verification_level: 3,
    ghost_mode: false,
    default_radius_miles: 40,
    created_at: "2026-01-10T08:00:00Z",
    perspectives_read: 310,
  ...
  },
  {
    ...
    username: "rachel_detroit",
    display_name: "Rachel Dominguez",
    avatar_url: null,
    home_community_id: "comm-detroit-labor",
    verification_level: 2,
    ghost_mode: false,
    default_radius_miles: 20,
    created_at: "2026-02-28T16:00:00Z",
    perspectives_read: 156,
    communities_engaged: 7,
    connections_made: 6,
  },
];
...
export const SEED_POSTS: Post[] = [
  {
    ...
    community_id: "comm-mexican-american",
    topic_id: "topic-border-policy",
    content: "Bridge wait times hit 3 hours today. My tía missed her doctor's appointment on the other side. This is real life, not politics.",
    image_url: null,
    post_type: "permanent" as PostType,
    radius_miles: 20 as RadiusMiles,
    expires_at: null,
    latitude: 31.76,
    longitude: -106.49,
    like_count: 24,
  ...
  },
  {
    ...
    community_id: "comm-rural-appalachia",
    topic_id: "topic-remote-work",
    content: "New coworking space opened in the old bank building downtown. Five years ago this building was boarded up. Strange times.",
    image_url: null,
    post_type: "permanent" as PostType,
    radius_miles: 30 as RadiusMiles,
    expires_at: null,
    latitude: 38.35,
    longitude: -81.63,
    like_count: 31,
  ...
  },
  {
    ...
    community_id: "comm-bay-area-tech",
    topic_id: "topic-ev-transition",
    content: "Just drove my EV from SF to Tahoe. Three charging stops, each under 20 min. The infrastructure is better than people think — at least on this corridor.",
    image_url: null,
    post_type: "permanent" as PostType,
    radius_miles: 20 as RadiusMiles,
    expires_at: null,
  ...
  },
  {
    ...
    community_id: "comm-hbcu-students",
    topic_id: "topic-free-speech",
    content: "Our student government just voted to invite speakers from across the political spectrum next semester. The debate about the debate was more productive than I expected.",
    image_url: null,
    post_type: "permanent" as PostType,
    radius_miles: 10 as RadiusMiles,
    expires_at: null,
    latitude: 33.75,
    longitude: -84.39,
    like_count: 42,
  ...
  },
  {
    ...
    community_id: "comm-native-tribal",
    topic_id: "topic-water-rights",
    content: "Elders meeting today about the new water compact proposal. Whatever gets decided in DC, we'll still be here protecting this water like we always have.",
    image_url: null,
    post_type: "permanent" as PostType,
    radius_miles: 40 as RadiusMiles,
    expires_at: null,
    latitude: 43.01,
    longitude: -102.55,
    like_count: 56,
  ...
  },
  {
    ...
    community_id: "comm-detroit-labor",
    topic_id: "topic-ev-transition",
    content: "Third buddy this month who got the retraining notice. They say it's an 'opportunity.' Hard to see it that way when you're 52 with a mortgage.",
    image_url: null,
    post_type: "permanent" as PostType,
    radius_miles: 20 as RadiusMiles,
    expires_at: null,
    ...
    comment_count: 22,
    share_count: 14,
    created_at: "2026-03-19T07:15:00Z",
    user: SEED_USERS[5],
    community: SEED_COMMUNITIES[8],
  },
];

export const SEED_STORIES: Post[] = [
  {
    id: "story-1",
    user_id: "user-1",
    community_id: "comm-mexican-american",
    topic_id: "topic-border-policy",
    content: "Morning at the bridge. Same faces, longer lines. 📍 Paso del Norte",
    image_url: null,
    post_type: "story" as PostType,
    radius_miles: 20 as RadiusMiles,
  ...
  },
  {
    ...
    community_id: "comm-rural-appalachia",
    topic_id: "topic-remote-work",
    content: "Fog rolling through the hollow this morning. This view is why people move here — and why some of us never left.",
    image_url: null,
    post_type: "story" as PostType,
    radius_miles: 30 as RadiusMiles,
  ...
  },
  {
    ...
    community_id: "comm-native-tribal",
    topic_id: "topic-water-rights",
    content: "Youth council just finished planting along the creek. Sovereignty starts with the land and water.",
    image_url: null,
    post_type: "story" as PostType,
    radius_miles: 40 as RadiusMiles,
  ...
  },
  {
    ...
    community_id: "comm-detroit-labor",
    topic_id: "topic-ev-transition",
    content: "Last shift on the old line. Tomorrow we start EV battery assembly training. Bittersweet.",
    image_url: null,
    post_type: "story" as PostType,
    radius_miles: 20 as RadiusMiles,
  ...
  },
  {
    ...
    community_id: "comm-bay-area-tech",
    topic_id: null,
    content: "Office is empty again. Whole team working from coffee shops and co-living spaces. The future is distributed.",
    image_url: null,
    post_type: "story" as PostType,
    radius_miles: 20 as RadiusMiles,
  ...
  },
  {
    ...
    community_id: "comm-hbcu-students",
    topic_id: "topic-free-speech",
    content: "Campus quad packed for the open mic event. More listening than shouting. Progress.",
    image_url: null,
    post_type: "story" as PostType,
    radius_miles: 10 as RadiusMiles,
    expires_at: "2026-03-20T21:00:00Z",
    latitude: 33.75,
    longitude: -84.39,
    like_count: 28,
    comment_count: 0,
...
export function getStoryGroups(): StoryGroup[] {
  ...
  for (const story of SEED_STORIES) {
    const key = story.community_id ?? story.user_id;
    if (!groups.has(key)) {
      const community = story.community;
      const user = story.user;
      groups.set(key, {
        id: key,
        type: community ? "community" : "user",
        name: community?.name ?? user?.display_name ?? "Unknown",
        communityType: community?.community_type ?? "civic",
        colorHex: community?.color_hex ?? "#4A9EFF",
...
export function getPostsByTopic(slug: string): Post[] {
  return SEED_POSTS.filter((p) => {
    const topic = SEED_TOPICS.find((t) => t.id === p.topic_id);
