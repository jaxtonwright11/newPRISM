  ...
  return (
    <div className="min-h-screen bg-prism-bg-base">
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        {/* Active topics with comparison links */}
            ...
            <div className="flex gap-2 overflow-x-auto no-scrollbar pb-1">
              {activeTopics.map((topic) => (
                <Link
                  ...
                  className="bg-prism-bg-surface rounded-lg border border-prism-border px-3 py-2 hover:bg-prism-bg-elevated hover:border-prism-accent-primary/30 transition-colors shrink-0 flex items-center gap-2"
                >
                  <svg className="w-3.5 h-3.5 text-prism-accent-primary shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
