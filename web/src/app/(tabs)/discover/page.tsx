    ...
    <div className="flex flex-col h-full">
      ...
      <header className="px-4 pt-4 pb-2">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link
            href="/insights"
            className="flex items-center gap-1.5 text-[11px] px-2.5 py-1 rounded-full border border-[var(--bg-elevated)] text-[var(--text-secondary)] hover:text-[var(--accent-primary)] hover:border-[var(--accent-primary)]/30 transition-all"
          >
