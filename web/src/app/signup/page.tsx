        ...
        {!confirmationSent && <><form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-1.5 mt-1.5">
              <div className={`h-0.5 flex-1 rounded-full transition-colors ${password.length >= 8 ? "bg-[var(--live-indicator)]" : "bg-[var(--bg-elevated)]"}`} />
              <div className={`h-0.5 flex-1 rounded-full transition-colors ${password.length >= 10 ? "bg-[var(--live-indicator)]" : "bg-[var(--bg-elevated)]"}`} />
              <div className={`h-0.5 flex-1 rounded-full transition-colors ${password.length >= 12 && /[^a-zA-Z0-9]/.test(password) ? "bg-[var(--live-indicator)]" : "bg-[var(--bg-elevated)]"}`} />
            </div>
