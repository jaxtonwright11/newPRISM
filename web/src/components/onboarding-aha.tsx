  ...
  if (step === "prompt") {
    return (
      <div className="absolute inset-0 z-20 flex flex-col justify-end pointer-events-none">
        ...
        <div className="absolute top-4 left-4 flex items-center gap-2 bg-prism-bg-base/85 backdrop-blur-md px-3 py-2 rounded-full border border-prism-border pointer-events-auto">
        ...
        <div className="p-4 pointer-events-auto">
          <div className="max-w-lg mx-auto">
            <div className="bg-prism-bg-surface/95 backdrop-blur-lg border border-prism-border rounded-2xl p-5 mb-3 shadow-xl">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-prism-accent-primary text-white text-sm font-semibold hover:bg-prism-accent-primary/90 transition-colors flex items-center justify-center gap-2 shadow-lg shadow-prism-accent-primary/20"
            >
          ...
          <div className="max-w-lg mx-auto space-y-3">
            {twoCards.map((p, i) => {
              ...
              return (
                <div
                  key={p.id}
                  className={`bg-prism-bg-surface/95 backdrop-blur-lg border border-prism-border rounded-xl p-5 shadow-xl transition-all duration-500 ${
                    ...
                    <div>
                      <div className="flex items-center gap-1">
                        ...
                        {p.community.verified && (
                          <svg className="w-3.5 h-3.5 text-prism-accent-live" viewBox="0 0 20 20" fill="currentColor">
            ...
            >
              <button
                ...
                className="w-full py-3 rounded-xl bg-prism-accent-primary text-white text-sm font-semibold hover:bg-prism-accent-primary/90 transition-colors shadow-lg"
              >
  ...
  if (step === "signup") {
    return (
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none">
        <div className="absolute inset-0 bg-prism-bg-base/70 backdrop-blur-md pointer-events-auto" onClick={dismiss} />
